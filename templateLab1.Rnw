...
<<echo=FALSE, size='scriptsize'>>=
 ...
 VADeaths.table<-xtable(VADeaths, label="VADeaths.tab") # we can now reference VADeaths.tab
 @
\begin{table}[H]
 \begin{center}
 ...
 @
% I'm still not quite sure this is right...
  \caption{Death Rates per 1000 in Virginia (1940)}
  \label{VADeaths.tab}
 \end{center}
\end{table}
...
<<penguinplot, eval=FALSE, size='scriptsize'>>=
